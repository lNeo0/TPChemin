...
public class Car {
    ...
    public Car(Ville origine, Ville destination, Moyen means, LocalTime departureTime, int duration, int financial, int cost, int co2, int confort, int nbRepetitions, int frequence) {
